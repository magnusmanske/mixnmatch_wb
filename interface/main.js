...
$(document).ready ( function () {
    ...
    Promise.all ( [
            vue_components.loadComponents ( ['widar','autodesc','wd-date','wd-link','tool-translate','tool-navbar','commons-thumbnail','snak','batch-navigator','value-validator','typeahead-search',
